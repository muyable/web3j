...
public class TypeDecoderTestCYT {
    ...
    */
    ...
    public void testDynamicBytes() {
       ...
       // byte[] bytes = getFileBytes("C:\\Users\\muyab\\Pictures\\五笔码图.jpg");
        byte[] encodedBytesStr = getFileBytes("H:\\github-projects\\oohforce-baas-demo\\tmp\\filebytesstr.txt"); //(这个是五笔码图的编码后的字符串)
        System.out.println(encodedBytesStr.length);
        DynamicBytes fileContentRawBytes = TypeDecoder.decodeDynamicBytes(new String(encodedBytesStr),0); //解码出五笔码图文件的原字节
        System.out.println(fileContentRawBytes.getValue().length);
        write2File(fileContentRawBytes.getValue(),"H:\\github-projects\\oohforce-baas-demo\\tmp\\file_decoded.jpg");//根据五笔码图文件的原字节,还原出.jpg文件.
    ...
    public static byte[] getFileBytes(String file) {
        try {
            //type类型，及图片的值
            // String file = "C:\\Users\\muyab\\Pictures\\五笔码图.jpg";
            // String file = "C:\\Users\\muyab\\Pictures\\Camera Roll\\QQ图片20180921094549.png";
            FileInputStream is = new FileInputStream(file);
            //FileOutputStream os = new FileOutputStream("H:\\github-projects\\oohforce-baas-demo\\tmp\\file.jpg");
            ...
            System.out.println("文件大小为：" + allBytes.length / 1024 + "K");
            //os.write(allBytes);
            //os.close();
            return allBytes;
    ...
    public static File write2File(byte[] bytes, String file) {
        try {
            //type类型，及图片的值
            // String file = "C:\\Users\\muyab\\Pictures\\五笔码图.jpg";
            // String file = "C:\\Users\\muyab\\Pictures\\Camera Roll\\QQ图片20180921094549.png";
            // String file = "H:\\github-projects\\oohforce-baas-demo\\tmp\\file.jpg";
...
//                //                System.out.println(str);
//                //写入相关文件
//                os.write(bytes, 0, n); //TODO 是否需要优化成分批次写
//            }
            os.write(bytes);
            System.out.println("文件大小=" + bytes.length / 1024 + "K,字节数="+bytes.length+"bytes");
            os.write(bytes);
            os.close();
